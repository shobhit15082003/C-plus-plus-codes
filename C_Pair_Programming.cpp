...
void solve()
{
    ...
    vin(a,n);
    vin(b,m);
    ll stop1=0,stop2=0,last1=0,last2=0,com1=0,com2=0;
    vll ans;
    while((stop1==0||stop2==0)&&(com1==0||com2==0))
    {
       // for(ll i=last1;i<n&&stop1==0&&com1==0;i++)
        if(last1<n&&stop1==0&&com1==0)
        {
            if(a[last1]==0)
            {
                k++;
       ...
       // for(ll i=last2;i<m&&stop2==0&&com2==0;i++)
       else if(last2<m&&stop2==0&&com2==0)
        {
            if(b[last2]==0)
            {
                k++;
