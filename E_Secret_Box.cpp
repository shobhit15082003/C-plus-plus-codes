  ...
  //  hello;
    ...
    for(ll i=x;i>=1;i--)
    {
        for(ll j=y;j>=1;j--)
        {
            ...
            if(k%ola==0&&(k/ola)<=z)
            {
                ans=max(ans,(y-j+1)*(x-i+1)*(z-(k/ola)+1));
            }
        }
    }
    // if(ans<0)
    ...
    cout(ans);
//      cout(aka.size());
//     cout<<aka[0]<<" "<<yka[0]<<" "<<zka[0]<<endl;
// cout<<aka[1]<<" "<<yka[1]<<" "<<zka[1]<<endl;
//     cout<<aka[2]<<" "<<yka[2]<<" "<<zka[2]<<endl;
        // ll count=0;
        // for (ll i = 0; i < aka.size(); i++)
        // {
        //     if(aka[i]==1&&yka[i]==1)
        //     {
        //         cout(zka[i]);
        //         return;
        //     }
        //     else if(aka[i]==1&&zka[i]==1)
        //     {
        //         cout(yka[i]);
        //         return;
        //     }
        //     else if(zka[i]==1&&yka[i]==1)
        //     {
        //         cout(aka[i]);
        //         return;
        //     }
