...
void solve()
{
  ...
  //  hello;
    ...
    // ll count = 0, index = -1;
    // index = upper_bound(all(p), n) - p.begin() - 1;
    ...
    //     return;
    // }
    //  ll baaka=upper_bound(all(v),p[index])-v.begin()-1;
    //   ll baka=upper_bound(all(v),p[index-1])-v.begin()-1;
    // if(v[baaka]!=p[index])
    // {
    //     cout(1);
    //     cout(p[index]);
